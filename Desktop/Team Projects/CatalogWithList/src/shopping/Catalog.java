...
public class Catalog {
	...
	public void loadItems() {
		...
		ArrayList<String> item = new ArrayList<>(12);
	...
	public StringBuilder getWholeCatalog() {
		...
		for (int i = 0; i <items.size(); i++) {
			 ...
			 sb.append(items.get(i)).append("-").append(prices.get(i)).append("-").append(monthlyPayments.get(i)).append("\n"); 
	...
	public String getItemDetails(String item) {
		...
		for (int i = 0; i < items.size(); i++) {
			...
			if(items.get(i).equalsIgnoreCase(item)) 
				...
				s=items.get(i)+"-"+prices.get(i)+"-"+monthlyPayments.get(i);
	...
	public void updatePrice(String item, double newPrice) {
		...
		loadWholeCatalog();
		  for (int i = 0; i < items.size(); i++) {
			  ...
			  if(items.get(i).equalsIgnoreCase(item)) prices.set(i, newPrice);  
			  
			  
//			  if (item.equalsIgnoreCase(items.get(i))) {
//		      prices.set(prices.indexOf(prices.get(i)), newPrice);
//		      monthlyPayments.set(monthlyPayments.indexOf(monthlyPayments.get(i)), newPrice/12);
//		    
//		  }
		  }
